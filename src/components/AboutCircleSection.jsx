...
export default function AboutCircleSection({ setActiveTab }) {
  const handleDiscoverMore = () => {
    if (setActiveTab) {
      setActiveTab('about-story');
      // Scroll smoothly to top when navigating
      window.scrollTo({ top: 0, behavior: 'smooth' });
    }
  };

  return (
    <section className={styles.aboutCircleSection} id="about-worlify-foundation">
      <div className="container">
        <div className={styles.aboutCircleGrid}>
          ...
          <div className={styles.aboutCircleContent}>
            <span className={styles.aboutTagline}>ABOUT US</span>
