...
const INITIAL_DOCUMENTS = [
  ...
  },
  {
    ...
    category: 'Tax',
    description: 'Tax exemption certification granted under Section 12A of the Income Tax Act, 1961 for charitable trust income.',
    authority: 'Income Tax Department',
    regNo: '12A/MUM/2021-22',
    issueDate: '05 Apr 2021',
    renewalDate: 'Permanent',
    fileSize: '1.1 MB',
    fileType: 'PDF',
    status: 'Tax Exempt',
  ...
  },
  {
    ...
    authority: 'Income Tax Department',
    regNo: '80G/MUM/2021-22',
    issueDate: '08 Apr 2021',
    renewalDate: 'Permanent',
    fileSize: '1.1 MB',
    fileType: 'PDF',
    status: 'Tax Exempt',
